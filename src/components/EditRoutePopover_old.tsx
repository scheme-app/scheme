...
const FolderSelector: FC<FolderSelectorPropTypes> = ({
  ...
  const { data, status }: { data: any; status: any } = useQuery(
    ["folders"],
    getFolders({ projectId: /*project.id*/ "cl7xvupzq0988lr1o9x5g03qd" }) as any
  );
            ...
            <div className="pr-40">
              <div className="mt-4">
                ...
                <Field
                  ...
                  className="text-md h-[2.2rem] w-[22rem] rounded-[0.3rem] border-[1.5px] border-[#E4E4E4] py-1.5 px-3 font-light text-[#969696] focus:outline-none focus:ring-2 focus:ring-[#F2F2F2]"
                />
              </div>
              <div className="mt-4 flex flex-row gap-x-10">
                ...
                <div className="w-full">
                  <h1 className="mb-2 text-sm">Folder</h1>
                  <div className="flex h-[2.15rem] flex-row items-center justify-between rounded-[0.3rem] border-[1.5px] border-[#E4E4E4] py-2 px-3">
                    ...
                    >
                      <FiChevronDown className="h-4 w-4 text-[#969696]" />
                    </button>
                  </div>
